...
class TvlnvFrameReader(_object):
    ...
    def __init__(self, the_word):
        this = _example.new_TvlnvFrameReader(the_word)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _example.delete_TvlnvFrameReader
    __del__ = lambda self: None

    def updateWord(self, word):
        return _example.TvlnvFrameReader_updateWord(self, word)

    def getWord(self):
        return _example.TvlnvFrameReader_getWord(self)
TvlnvFrameReader_swigregister = _example.TvlnvFrameReader_swigregister
