...
class JaxMemManager(tvlnv.MemManager):
    """MemManager implementation which allocates jax arrays."""
    ...
    def allocate(self, size):
        tensor = jnp.empty(size, dtype=jnp.uint8)
...
def nv12_to_rgb(planar_yuv, h, w):
    ...
    Args:
        planar_yuv (jax.numpy.array): Planar YUV pixels in [0, 255] value range.
        h: Height of the image.
        w: Width of the image.

    Returns:
        jax.numpy.array: RGB pixels in [0, 255] value range.
    """
